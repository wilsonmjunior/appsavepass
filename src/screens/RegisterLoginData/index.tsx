...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    const loginsResponse = JSON.parse(await AsyncStorage.getItem(dataKey)) as LoginListDataProps

    const loginsData = loginsResponse ? [...loginsResponse, newLoginData] : [newLoginData];

    await AsyncStorage.setItem(dataKey, JSON.stringify(loginsData));
